...
const Navbar = (props) => {
    ...
    let friendsElements = props.sidebar.friends.map(friends => <FriendsItem key={friends.id} id={friends.id} name={friends.name} image={friends.image} />)
    ...
    return (
        <nav className={style.nav}>
            <ul>
                ...
                <li className={style.nav__list}>
                    <NavLink to="/users" className={style.nav__item} activeClassName={style.nav__item_active}>Users</NavLink>
                </li>
                <li className={style.nav__list}>
